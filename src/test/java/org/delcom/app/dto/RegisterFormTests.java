...
class RegisterFormTest {
    ...
    void validation_Fail_WhenPasswordIsNull() {
        ...
        assertEquals(1, violations.size());
        // Perbaikan Baris 148
        assertEquals("Password harus diisi", violations.iterator().next().getMessage());
    }
    ...
    void validation_Fail_WhenPasswordIsEmpty() {
        ...
        // Note: Anda mungkin perlu mendapatkan pesan yang benar dari list violations jika ada dua
        // Untuk saat ini biarkan hanya satu assertion pesan jika memang hanya 1 pesan yang relevan.
    }
    ...
    void validation_Fail_WhenAllFieldsNull() {
        ...
        // Perbaikan Baris 200 (sebelumnya 'Kata sandi harus diisi')
        assertTrue(violationMessages.contains("Password harus diisi")); 
    }
    ...
    void validation_Fail_WhenEmailAndPasswordInvalid() {
        ...
        assertTrue(violationMessages.contains("Format email tidak valid"));
        // Perbaikan pesan karena password empty string memicu 2 error
        assertTrue(violationMessages.contains("Password harus diisi") || violationMessages.contains("Kata sandi harus diisi"));
        // Asumsi: 1 error dari Email, 2 error dari Password (misalnya @NotBlank dan @Size), total 3.
    }
    ...
    void validation_Fail_WhenNameAndPasswordInvalid() {
        ...
        // Perbaikan pesan karena password empty string memicu 2 error
        assertTrue(violationMessages.contains("Password harus diisi") || violationMessages.contains("Kata sandi harus diisi"));
        // Asumsi: 1 error dari Name, 2 error dari Password (misalnya @NotBlank dan @Size), total 3.
    }
